...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\nName: Varun Gupta", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnr : 211B340", font='Arial 16 bold', fg='blue').pack()
    ...
    def check_booking_page(self):
        ...
        def check_tkt():
            ...
            if len(mobile)==10 and mobile.isdigit():
                ...
                Label(text="YOUR TICKET", font='Arial 12 bold', bg='green3',fg='white').grid(row=6,columnspan=12 )
